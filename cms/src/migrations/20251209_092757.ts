...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_users_roles" AS ENUM('admin', 'client-admin', 'user');
  ...
  CREATE TABLE "pages" (
  	...
  	"mission_icon" "enum_pages_mission_icon" DEFAULT 'Target',
  	"mission_title" varchar DEFAULT 'Our Mission',
  	"mission_description" varchar,
  	"vision_icon" "enum_pages_vision_icon" DEFAULT 'Eye',
  	"vision_title" varchar DEFAULT 'Our Vision',
  	"vision_description" varchar,
  	"values_icon" "enum_pages_values_icon" DEFAULT 'Users',
  ...
  CREATE TABLE "_pages_v" (
  	...
  	"version_mission_icon" "enum__pages_v_version_mission_icon" DEFAULT 'Target',
  	"version_mission_title" varchar DEFAULT 'Our Mission',
  	"version_mission_description" varchar,
  	"version_vision_icon" "enum__pages_v_version_vision_icon" DEFAULT 'Eye',
  	"version_vision_title" varchar DEFAULT 'Our Vision',
  	"version_vision_description" varchar,
  	"version_values_icon" "enum__pages_v_version_values_icon" DEFAULT 'Users',
  ...
  CREATE TABLE "users" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"name" varchar,
  	"enable_admin_panel_access" boolean DEFAULT false,
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"created_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  ...
  CREATE TABLE "roles_permissions" (
  	...
  	"action" "enum_roles_permissions_action" DEFAULT 'read' NOT NULL
  );
